...
python main.py --N 8000 --batch-size 10 --model1 RWKV/rwkv-4-3b-pile --model2 RWKV/rwkv-4-3b-pile --corpus-path "monology/pile-uncopyrighted" --name-tag "8kpile-a"  
python main.py --N 8000 --batch-size 10 --model1 RWKV/rwkv-4-3b-pile --model2 RWKV/rwkv-4-3b-pile --corpus-path "monology/pile-uncopyrighted" --name-tag "8kpile-b"  
