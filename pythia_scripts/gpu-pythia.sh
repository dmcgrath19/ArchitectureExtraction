...
#$ -N PI-KING
#$ -o /exports/eddie/scratch/s2558433/job_runs/PI-mambax-130m_$JOB_ID.log
#$ -e /exports/eddie/scratch/s2558433/job_runs/PI-mambax-130m_$JOB_ID.err
#$ -cwd
#$ -q gpu
#$ -pe gpu-a100 1
#$ -l h_vmem=500G
...
# Run the main script
python main.py --N 10 --batch-size 10 --model1 EleutherAI/pythia-2.8b --model2 EleutherAI/pythia-160m --corpus-path monology/pile-uncopyrighted
