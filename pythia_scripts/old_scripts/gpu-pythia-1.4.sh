...
#$ -N Py-1.4
#$ -o /exports/eddie/scratch/s2558433/job_runs/Pythia1.4_$JOB_ID.log
#$ -e /exports/eddie/scratch/s2558433/job_runs/Pythia1.4_$JOB_ID.err
#$ -cwd
#$ -q gpu
#$ -pe gpu-a100 1
#$ -l h_vmem=500G
...
python pythia-main.py --N 10000 --batch-size 10 --model1 EleutherAI/pythia-2.8b --model2 EleutherAI/pythia-1.4b --corpus-path "monology/pile-uncopyrighted" --name-tag "10kpile"
python pythia-main.py --N 10000 --batch-size 10 --model1 EleutherAI/pythia-2.8b --model2 EleutherAI/pythia-160m --corpus-path "monology/pile-uncopyrighted" --name-tag "10kpile"
