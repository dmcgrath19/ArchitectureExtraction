...
# Run the main script
# python mamba-main.py --N 10000 --batch-size 10 --model1 state-spaces/mamba-2.8b-hf --model2 state-spaces/mamba-370m-hf '--corpus-path monology/pile-uncopyrighted' --name-tag '10k-pile-1' --random-seed 33
# mv output*.txt output*.csv /prev-runs/mamba-370/

# python mamba-main.py --N 10000 --batch-size 10 --model1 state-spaces/mamba-2.8b-hf --model2 state-spaces/mamba-370m-hf --corpus-path monology/pile-uncopyrighted --name-tag 10k-pile-2 --random-seed 36
# mv output*.txt output*.csv /prev-runs/mamba-370/

# python mamba-main.py --N 10000 --batch-size 10 --model1 state-spaces/mamba-2.8b-hf --model2 state-spaces/mamba-370m-hf --corpus-path monology/pile-uncopyrighted --name-tag 10k-pile-3 --random-seed 53
# mv output*.txt output*.csv /prev-runs/mamba-370/

# python mamba-main.py --N 10000 --batch-size 10 --model1 state-spaces/mamba-2.8b-hf --model2 state-spaces/mamba-370m-hf --corpus-path monology/pile-uncopyrighted --name-tag 10k-pile-4 --random-seed 63
# mv output*.txt output*.csv /prev-runs/mamba-370/

# python mamba-main.py --N 10000 --batch-size 10 --model1 state-spaces/mamba-2.8b-hf --model2 state-spaces/mamba-370m-hf --corpus-path monology/pile-uncopyrighted --name-tag 10k-pile-5 --random-seed 66
# mv output*.txt output*.csv /prev-runs/mamba-370/
