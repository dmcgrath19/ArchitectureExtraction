...
python main.py --N 10000 --batch-size 10 --model1 state-spaces/mamba-130m-hf --model2 state-spaces/mamba-130m-hf --corpus-path "monology/pile-uncopyrighted" --name-tag "10kpile-3" --is-mamba
