...
python main.py --N 10000 --batch-size 10 --model1 state-spaces/mamba-160m-hf --model2 state-spaces/mamba-160m-hf --corpus-path "monology/pile-uncopyrighted" --name-tag "input-50" --is-mamba --input-len 50
